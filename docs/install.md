...
_Note: that for the security of your chats will need to serve VChat over HTTPS.
...
1. Enter the URL into your browser and log into VChat!
...
VChat Web is now also available as a Debian package for Debian and Ubuntu based systems.
...
[VChat Web Modules](https://github.com/element-hq/element-modules/tree/main/packages/element-web-module-api) can be dynamically loaded
