...
So you want to contribute to VChat Web? That is awesome!
...
All the issues for VChat Web live in the
...
- It already has approval from VChat Web's designers (look for comments from
  members of the
...
**VChat Web's Design and Product teams tend to be very busy**, so if you make
...
Thank you again for contributing to VChat Web. We welcome your contributions
