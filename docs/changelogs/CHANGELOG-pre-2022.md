...
VChat Web 1.7.29 fixes (by upgrading to olm 3.2.3) an issue in code used for
...
VChat Web 1.7.28 fixes (by upgrading to matrix-react-sdk 3.21.0) a low
...
VChat Web 1.7.22 fixes (by upgrading to matrix-react-sdk 3.15.0) a moderate
 ...
 * Fix Riot->VChat in permalinkPrefix docs
 ...
 * Stop building code and types for VChat layer
 ...
 * Update widget API for good measure in VChat Web
   [\#15812](https://github.com/vector-im/element-web/pull/15812)
 * Stop publishing VChat to NPM
 ...
 * Rebrand the webpack pipeline for VChat
...
VChat Web 1.7.5 fixes an issue where encrypted state events could break incoming call handling.
 ...
 * Update links in README.md to point to VChat
 ...
 * Change Riot to VChat in readme
 ...
 * Link to VChat in F-Droid as well
 ...
 * Update jitsi.md with VChat Android details
...
VChat Web 1.7.3 (as well as the earlier release 1.7.2) fixes an issue where
...
VChat Web 1.7.3 (as well as the earlier release 1.7.2) fixes an issue where an
unexpected language ID in a code block could cause VChat to crash. Thanks to
 ...
 * Update blog and twitter links to point to VChat
 ...
 * App name changed from Riot to VChat
