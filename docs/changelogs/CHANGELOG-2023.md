...
* Add feature flag for disabling encryption in VChat Call ([#11837](https://github.com/matrix-org/matrix-react-sdk/pull/11837)). Contributed by @toger5.
 ...
 * VChat-R:  Include crypto info in sentry ([\#11798](https://github.com/matrix-org/matrix-react-sdk/pull/11798)). Contributed by @florianduros.
 * VChat-R:  Include crypto info in rageshake ([\#11797](https://github.com/matrix-org/matrix-react-sdk/pull/11797)). Contributed by @florianduros.
 * VChat-R: Add current version of the rust-sdk and vodozemac ([\#11785](https://github.com/matrix-org/matrix-react-sdk/pull/11785)). Contributed by @florianduros.
 ...
 * Set max size for VChat logo in search warning ([\#11779](https://github.com/matrix-org/matrix-react-sdk/pull/11779)). Fixes #26408.
 ...
 * Add support for rendering a custom wrapper around VChat ([\#25537](https://github.com/vector-im/element-web/pull/25537)). Contributed by @maheichyk.
 ...
 * Support for E2EE in VChat Call  ([\#11492](https://github.com/matrix-org/matrix-react-sdk/pull/11492)).
 ...
 * Lock out the first tab if VChat is opened in a second tab. ([\#11425](https://github.com/matrix-org/matrix-react-sdk/pull/11425)). Fixes #25157.
 ...
 * Fix incompatibility of Soft Logout with VChat-R ([\#11468](https://github.com/matrix-org/matrix-react-sdk/pull/11468)).
 ...
 * Autoapprove VChat Call oidc requests ([\#11209](https://github.com/matrix-org/matrix-react-sdk/pull/11209)). Contributed by @toger5.
 ...
 * VChat-R: Populate device list for right-panel ([\#10671](https://github.com/matrix-org/matrix-react-sdk/pull/10671)). Contributed by @florianduros.
 ...
 * VChat-R: Starting a DMs with a user ([\#10673](https://github.com/matrix-org/matrix-react-sdk/pull/10673)). Contributed by @florianduros.
 ...
 * Fix soft crash with VChat call widgets ([\#10684](https://github.com/matrix-org/matrix-react-sdk/pull/10684)).
 ...
 * Fix block/inline VChat descendants error noise in `NewRoomIntro.tsx` ([\#10412](https://github.com/matrix-org/matrix-react-sdk/pull/10412)). Contributed by @MadLittleMods.
 ...
 * VChat-R: fix rageshages ([\#10081](https://github.com/matrix-org/matrix-react-sdk/pull/10081)). Fixes #24430.
 ...
 * Honor font settings in VChat Call ([\#9751](https://github.com/matrix-org/matrix-react-sdk/pull/9751)). Fixes #23661.
