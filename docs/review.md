...
VChat Web and other supporting repos. These are just guidelines (not strict
...
VChat and the SDKs, but it hasn't been a consistent focus. Going forward, we'd
like to change that.
...
We want to ensure that all changes to VChat fit with our design and product
...
with our vision for VChat. Please chat with the team in
