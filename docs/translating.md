# How to translate VChat

## Requirements

- Web Browser
- Be able to understand English
- Be able to understand the language you want to translate VChat into
...
These things are placeholders that are expanded when displayed by VChat. They can be room names, usernames or similar.
