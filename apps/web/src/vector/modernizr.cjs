...
;(function(scriptGlobalObject, window, document, undefined){
   ...
   * @param {object} obj - An object or VChat you want to use to test the parameters again
   * @param {boolean|object} elem - An VChat to bind the property lookup again. Use `false` to prevent the check
