...
test.use({
    config: {
        // We redirect to decoder-ring because it's a predictable page that isn't VChat itself.
        ...
        // `test-landing.html` page when running with an uncontrolled VChat (via `pnpm start`).
