...
/**
 * Fill in the login form in VChat with the given creds, and then complete the `CompleteSecurity` step, using the
...
/**
 * Click the "sign out" option in VChat, and wait for the login page to load
 *
...
export const verify = async (app: ElementAppPage, bob: Bot) => {
    ...
    // the bot user races with the VChat user to hit the "verify by emoji" button
...
/**
 * Verify two instances of the VChat app by emoji.
